library("DESeq2")
data <- read.delim("/Users/joru1876/Google_Drive/Colorado_University/Jonathan/TFEA/test_files/test_count_file.bed", sep="	", header=TRUE)
...
res1 <- results(dds, alpha = 0.05, contrast=c("treatment", "condition2",
                                                            "condition1"))

resShrink <- lfcShrink(dds, res = res1, contrast = c("treatment", "condition2",
                                                                "condition1"))
